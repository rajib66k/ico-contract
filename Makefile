...
install :; forge install foundry-rs/forge-std@v1.16.1 && forge install openzeppelin/openzeppelin-contracts@v5.6.1 && forge install smartcontractkit/chainlink-evm@v0.3.3
